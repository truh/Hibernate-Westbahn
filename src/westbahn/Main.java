...
public class Main
{
    ...
    public static void task01() throws ParseException, InterruptedException 
    {
        ...
        Zeitkarte t2 = new Zeitkarte();
        Zeitkarte t3 = new Zeitkarte();
        Zeitkarte t4 = new Zeitkarte();
        ...
        t2.setGueltigAb(new Date());
        t2.setTyp(ZeitkartenTyp.WOCHENKARTE);

        t3.setGueltigAb(new Date());
        t3.setTyp(ZeitkartenTyp.MONATSKARTE);

        t4.setGueltigAb(new Date());
        t4.setTyp(ZeitkartenTyp.JAHRESKARTE);
